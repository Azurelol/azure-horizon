...
export default class ModelCollection extends foundry.utils.Collection {
  ...
  constructor(documentName, documentClass, document, data) {
    super();
    Object.defineProperties(this, {
      name: { value: documentName, writable: false },
      _source: { value: data, writable: false },
      documentClass: { value: documentClass, writable: false },
    });
  }
  ...
  /**
	 ...
	 */
  getByType(type) {
    return Array.from(this.#documentsByType.get(type) ?? []).map((key) => this.get(key));
  }
