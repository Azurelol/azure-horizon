import { AudioDataModel } from "../api/_module.mjs";
 ...
 */
export default class CodexEntryDataModel extends foundry.abstract.DataModel {
  ...
  static get PLAYLIST() {
    return `Azure Horizon - ${StringUtils.localize("AH.Codex")}`;
  }
